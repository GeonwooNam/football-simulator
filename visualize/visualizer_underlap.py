...
def main():
    ...
    support_fullback = Player(player_id=4, position=np.array([75.0, 20.0, 0.0]), team_id=1, max_speed=35.0)
    ...
    while True:
        ...
        if not underlap and frame > 100:
            underlap = True
            support_fullback.compute_underlap_run(defender, inside_offset=4.5, move_intensity="SPRINT")
